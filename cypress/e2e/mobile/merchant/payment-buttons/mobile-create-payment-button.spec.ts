...
describe('Mobile - Merchant - Payment Buttons - Create Payment Button', () => {
  ...
  it('[Mobile] Create slider payment button', () => {
    ...
    cy.assertTabIsActive('Currency Settings')

    cy.get($.GENERAL.ICON.RIGHT)
      .should('be.visible')
      .click()
