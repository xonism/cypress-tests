...
describe('Mobile - Merchant - Payment Buttons - Dynamic', () => {
  ...
  it('[Mobile] Create pending order with dynamic payment button', () => {
  ...
  it('[Mobile] Create paid order with dynamic payment button', () => {
    cy.get('.invoice-header')
      .should('contain', fiatTargetAmount)
      .and('contain', fiatCurrencyCode)
