...
describe('Mobile - Merchant - Payment Buttons - Slider', () => {
  ...
  it('[Mobile] Create pending order with slider payment button', () => {
  ...
  it('[Mobile] Create paid order with slider payment button', () => {
    cy.urlContains('/invoice')
