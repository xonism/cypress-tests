...
describe('Mobile - Billing - Billing Subscriptions - Monthly', () => {
  ...
  const billingPaymentMethod = billingPaymentMethods.monthly
  ...
  it('[Mobile] Create new monthly subscription', () => {
