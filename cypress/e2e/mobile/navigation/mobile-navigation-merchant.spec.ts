...
describe('Mobile - Navigation - Merchant', () => {
  ...
  it('[Mobile] Navigate to "Withdrawals"', () => {
  ...
  it('[Mobile] Navigate to "Point of Sale"', () => {
  ...
  it('[Mobile] Navigate to "Payment Buttons"', () => {
