...
describe('Mobile - Navigation - Merchant - Billing', () => {
  ...
  it('[Mobile] Navigate to "Whats this?"', () => {
  ...
  it('[Mobile] Navigate to "Subscribers"', () => {
    cy.passBillingIntroduction()
  ...
  it('[Mobile] Navigate to "Subscriptions"', () => {
    cy.passBillingIntroduction()
  ...
  it('[Mobile] Navigate to "Payments"', () => {
    cy.passBillingIntroduction()
