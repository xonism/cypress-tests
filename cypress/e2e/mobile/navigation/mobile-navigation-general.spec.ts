...
describe('Mobile - Navigation - General', () => {
  ...
  it('[Mobile] Navigate to personal "Dashboard"', () => {
    ...
    cy.contains($.GENERAL.DASHBOARD_CARD, 'Open a Business Account')
      .should('be.visible')
      .within(() => {
        cy.contains($.GENERAL.BTN.BTN, 'Create a Business account')
          .should('be.visible')
      })
    ...
    cy.contains($.GENERAL.DASHBOARD_CARD, 'Check out our new Gift Cards section')
      .should('be.visible')
      .within(() => {
        cy.getButtonWithText('Go to shop')
          .should('be.visible')
      })
    ...
    cy.contains($.GENERAL.DASHBOARD_CARD, 'Earn rewards')
      .should('be.visible')
      .within(() => {
        cy.contains($.GENERAL.BTN.BTN, 'Create your referral link')
          .should('be.visible')
      })
  })

  it('[Mobile] Navigate to "Suggest a Feature"', () => {
    ...
    cy.get($.GENERAL.MODAL.CONTENT)
      ...
      .within(() => {
        ...
        // cy.get('button[type="submit"]') // bug on mobile
        //   .should('be.visible')
      })
  })

  it('[Mobile] Navigate to business "Dashboard"', () => {
    ...
    cy.contains($.GENERAL.DASHBOARD_CARD, 'Account Limits')
      .should('be.visible')
      .within(() => {
        cy.contains($.GENERAL.BTN.BTN, 'Start verification')
          .should('be.visible')
      })
    ...
    cy.contains($.GENERAL.DASHBOARD_CARD, 'Billing is live')
      .should('be.visible')
      .within(() => {
        cy.contains($.GENERAL.BTN.BTN, 'Learn more')
          .should('be.visible')
      })
