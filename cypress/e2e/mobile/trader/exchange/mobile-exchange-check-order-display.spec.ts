...
describe('Mobile - Trader - Exchange - Check order display', () => {
  ...
  it('[Mobile] Check if "Swap" order is displayed in "Dashboard" & "Orders"', () => {
  ...
  it('[Mobile] Check if paid "Swap" order is displayed in "Dashboard" & "Orders"', () => {
    cy.visit('/account/dashboard')
  ...
  it('[Mobile] Check if paid & withdrawn "Swap" order is displayed in "Balances"', () => {
