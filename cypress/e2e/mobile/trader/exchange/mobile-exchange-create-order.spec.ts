...
describe('Mobile - Trader - Exchange - Create Order', () => {
  ...
  it(`[Mobile] [Mark as Paid] Create ${sellCurrency.currencySymbol} to ${receiveCurrency.currencySymbol} exchange order`, () => {
