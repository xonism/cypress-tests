...
describe('Mobile - Trader - Buy - Check order display', () => {
  ...
  it('[Mobile] Check if "Buy" order is displayed in "Dashboard" & "Orders"', () => {
  ...
  it('[Mobile] Check if paid "Buy" order is displayed in "Dashboard" & "Orders"', () => {
    cy.visit('/account/dashboard')
  ...
  it('[Mobile] Check if paid & withdrawn "Buy" order is displayed in "Balances"', () => {
