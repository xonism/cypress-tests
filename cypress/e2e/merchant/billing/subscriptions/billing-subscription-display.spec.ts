...
describe('Billing - Subscriptions - Display', () => {
  ...
  it('Check "Draft" subscription status display', () => {
  ...
  it('Check "Completed" subscription status display', () => {
  ...
  it('Check "Active" subscription status display', () => {
