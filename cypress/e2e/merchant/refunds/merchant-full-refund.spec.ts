...
describe('Merchant - Refunds - Full Refund', () => {
  ...
  const reason = 'Testing full refund'
              ...
              .within(() => {
                ...
                cy.get('tbody tr')
                  ...
                  .within(() => {
                    ...
                    cy.assertTableDataCellContains(6, `${fiatTargetAmount} ${fiatCurrencyCode.toUpperCase()}`)
              ...
              .within(() => {
                cy.get('tbody tr')
                  ...
                  .within(() => {
                    ...
                    cy.assertTableDataCellContains(2, `${fiatTargetAmount} ${fiatCurrencyCode.toUpperCase()}`)
                  ...
                  .then((response) => {
                    ...
                    cy.getTableRow(1)
                      .within(() => {
                        ...
                        cy.assertTableDataCellContains(1, `${fiatTargetAmount} ${fiatCurrencyCode.toUpperCase()}`)
                    ...
                    cy.getTableRow(5)
                      .within(() => {
                        ...
                        cy.assertTableDataCellContains(2, reason)
                      })
