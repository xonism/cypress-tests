...
describe('Merchant - Payment Buttons - Display', () => {
  ...
  it('Check fixed payment button display', () => {
  ...
  it('Check slider payment button display', () => {
  ...
  it('Check dynamic payment button display', () => {
