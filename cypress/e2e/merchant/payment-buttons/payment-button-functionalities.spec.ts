...
describe('Merchant - Payment Buttons - Functionalities', () => {
  ...
  it('Check "Button Page" button functionality', () => {
    cy.getPaymentButtonsViaAPI()
      .then((response) => {
        ...
        cy.get($.PAYMENT_BUTTONS.BTN.BUTTON_PAGE_OPTION)
          .should('be.visible')
          .parent('a')
          .invoke('attr', 'href')
  ...
  it('Check "Edit" button functionality', () => {
    cy.get($.PAYMENT_BUTTONS.BTN.EDIT_OPTION)
      .should('be.visible')
      .click()
  ...
  it('Check "Enable" & "Disable" button functionality', () => {
    cy.get($.PAYMENT_BUTTONS.BTN.DISABLE_OPTION)
      .should('be.visible')
      .click()
    ...
    cy.get($.PAYMENT_BUTTONS.BTN.ENABLE_OPTION)
      .should('be.visible')
      .click()
  ...
  it('Check "Delete" button functionality', () => {
    cy.get($.PAYMENT_BUTTONS.BTN.DELETE_OPTION)
      .should('be.visible')
      .click()
