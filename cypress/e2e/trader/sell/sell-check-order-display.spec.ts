...
describe('Trader - Sell - Check order display', () => {
  ...
  it('Check if "Sell" order is displayed in "Dashboard" & "Orders"', () => {
  ...
  it('Check if paid "Sell" order is displayed in "Dashboard" & "Orders"', () => {
    cy.visit('/account/dashboard')
  ...
  it('Check if paid & withdrawn "Sell" order is displayed in "Balances"', () => {
