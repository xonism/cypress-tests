...
describe('Trader - Exchange - Create Order As Business', () => {
  ...
  it(`[Mark as Paid] Create ${sellCurrency.currencySymbol} to ${receiveCurrency.currencySymbol} exchange order as a business`, () => {
