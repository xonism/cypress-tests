...
describe('Payout Settings - Crypto Address Field Validation', () => {
  ...
  it('Enter invalid payout address', () => {
  ...
  it('Check address field whitespace validation', () => {
    cy.loginViaAPI(email, password)
  ...
  const enterAddressOfAnotherCurrency = (firstCurrency, secondCurrency) => {
    it(`Enter ${secondCurrency.currencySymbol} address into ${firstCurrency.currencySymbol} payout setting`, () => {
      cy.loginViaAPI(email, password)
