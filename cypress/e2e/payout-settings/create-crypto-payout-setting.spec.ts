...
describe('Payout Settings - Create Crypto Payout Setting', () => {
  ...
  for (const currency in cryptoPayoutCurrencyInfo) {
    const { currencyTitle, currencySymbol, payoutAddress, platform, payoutSettingTitle } = cryptoPayoutCurrencyInfo[currency]

    it(`Create ${currencySymbol} payout setting`, () => {
